...
AppWizard 已經為您建立了這個 FunctionGenerator DLL。這個 DLL 不僅
示範了使用 MFC 的基本概念，
也是您撰寫 DLL 的起點。

這個檔案包含一份摘要，
簡要說明構成您的 FunctionGenerator DLL 的所有檔案，它們個別的內容。
...
FunctionGenerator.h
    這是 DLL 的主要標頭檔。它宣告了
    CFunctionGeneratorApp 類別。

FunctionGenerator.cpp
    這是主要 DLL 原始程式檔。它含有 CFunctionGeneratorApp 類別。
